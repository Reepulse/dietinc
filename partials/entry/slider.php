	...
	<div class="wpex-post-slider-wrap wpex-loop-entry-media wpex-clr">
		...
		<div class="wpex-post-slider wpex-lightbox-gallery lightslider">
			...
			foreach ( $imgs as $img ) :
				...
				$thumbnail_url = wp_get_attachment_image_src( $img, 'entry', false );
				...
				if ( $thumbnail_url ) : ?>
					...
					<div class="wpex-post-slider-slide">
						...
						if ( 'on' == $lightbox_enabled ) : ?>
							...
							<a href="<?php echo $img_url; ?>" title="<?php echo esc_attr( $img_alt ); ?>" class="wpex-lightbox-item">
								<img src="<?php echo $thumbnail_url[0]; ?>" alt="<?php echo esc_attr( $img_alt ); ?>" width="<?php echo $thumbnail_url[1]; ?>" height="<?php echo $thumbnail_url[2]; ?>" />
							</a>
