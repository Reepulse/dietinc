    ...
    class WPEX_Social_Profiles_Widget extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                ...
                __( 'Chic - Social Profiles', 'chic' ),
                array( 'description'   => __( 'Displays icons with links to your social profiles with drag and drop support and Font Awesome Icons.', 'chic' ) )
            );
        }
            ...
            <?php echo $before_widget; ?>
                <?php if ( $title )
                    echo $before_title . $title . $after_title; ?>
                        <div class="wpex-social-profiles-widget wpex-social-color-buttons wpex-clr">
                            <?php
                            // ADD Style
                            $add_style = array();
                            if ( $size ) {
                                ...
                                foreach( $social_services as $key => $service ) {
                                    ...
                                    if ( $link ) {
                                        if ( 'youtube' == $key ) {
                                            ...
                                            <li>
                                                <a href="<?php echo esc_url( $link ); ?>" title="<?php echo esc_attr( $name ); ?>" <?php echo $add_style; ?><?php echo $target; ?> class="wpex-<?php echo $key; ?>">
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'target' ); ?>"><?php _e( 'Link Target:', 'chic' ); ?></label>
                <br />
                <select class='wpex-widget-select' name="<?php echo $this->get_field_name( 'target' ); ?>" id="<?php echo $this->get_field_id( 'target' ); ?>">
                    <option value="blank" <?php if ( $instance['target'] == 'blank' ) { ?>selected="selected"<?php } ?>><?php _e( 'Blank', 'chic' ); ?></option>
                    <option value="self" <?php if ( $instance['target'] == 'self' ) { ?>selected="selected"<?php } ?>><?php _e( 'Self', 'chic' ); ?></option>
                </select>
            </p>
            
            <p>
                <label for="<?php echo $this->get_field_id( 'size' ); ?>"><?php _e( 'Icon Size', 'chic' ); ?></label>
                ...
                <small><?php _e( 'Enter a size to be used for the height/width for the icon.', 'chic' ); ?></small>
            </p>

            <p>
                <label for="<?php echo $this->get_field_id( 'font_size' ); ?>"><?php _e( 'Icon Font Size', 'chic' ); ?></label>
                ...
                <small><?php _e( 'Enter a custom font size for the icons.', 'chic' ); ?></small>
            </p>

            <p>
                <label for="<?php echo $this->get_field_id( 'border_radius' ); ?>"><?php _e( 'Border Radius', 'chic' ); ?></label>
                ...
                <small><?php _e( 'Enter a custom border radius. For circular icons enter a number equal or greater to the Icon Size field above.', 'chic' ); ?></small>
            </p>

            <?php
            $field_id_services      = $this->get_field_id( 'social_services' );
            $field_name_services    = $this->get_field_name( 'social_services' ); ?>
            <h3 style="margin-top:20px;margin-bottom:0;"><?php _e( 'Social Links','chic' ); ?></h3>  
            <small style="display:block;margin-bottom:10px;"><?php _e( 'Enter the full URL to your social profile', 'chic' ); ?></small>
