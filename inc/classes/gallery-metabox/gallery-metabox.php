	...
	class WPEX_Gallery_Metabox {
		...
		function render() {
						...
						foreach ( $attachments as $attachment_id ) {
							if ( wp_attachment_is_image ( $attachment_id  ) ) {
								echo '<li class="image" data-attachment_id="' . $attachment_id . '"><div class="attachment-preview"><div class="thumbnail">
											...
											<a href="#" class="wpex-gmb-remove" title="' . __( 'Remove image', 'chic' ) . '"><div class="media-modal-icon"></div></a>
										</div></li>';
							}
						}
					} ?>
			...
			<p class="add_wpex_gallery_images hide-if-no-js">
				<a href="#" class="button-primary"><?php _e( 'Add/Edit Images', 'chic' ); ?></a>
			</p>
			<?php
				...
				jQuery(document).ready(function($){
					...
					jQuery( '.add_wpex_gallery_images' ).on( 'click', 'a', function( event ) {
						...
						image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
							...
							title: "<?php _e( 'Add Images to Gallery', 'chic' ); ?>",
							button: {
								text: "<?php _e( 'Add to gallery', 'chic' ); ?>",
							},
							multiple: true
						});
									 ...
									 $wpex_gallery_images.append('\
										<li class="image" data-attachment_id="' + attachment.id + '">\
											<div class="attachment-preview">\
											   ...
											   <a href="#" class="wpex-gmb-remove" title="<?php _e( 'Remove image', 'chic' ); ?>"><div class="media-modal-icon"></div></a>\
											</div>\
										</li>');
								}
							} );
