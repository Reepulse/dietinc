        ...
        public function create_admin_page() { ?>
            <div class="wrap">
                <h2 style="padding-right:0;">
                    <?php _e( 'Custom CSS', 'chic' ); ?>
                </h2>
                <p><?php _e( 'Use the form below to add custom CSS to tweak your theme design. These will be stored in your theme_mods.', 'chic' ); ?></p>
                <div style="margin:10px 0 20px;"><a href="#" class="button-secondary wpex-custom-css-toggle-skin"><?php _e( 'Toggle Skin', 'chic' ); ?></a></div>
